...
#define CUSTOM_MACHINE_NAME "ABARI 5 AXIS 3D PRINTER"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {152 , 1066, 1066, 1066 ,1066}
...
#define HOMING_FEEDRATE_MM_M { (3*50), (3*50), (3*50) ,(5*60),(5*60)}

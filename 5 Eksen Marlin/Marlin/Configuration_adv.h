...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Eksenleri Ayarla"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "Done"
  //#define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Hepsini Sifir Noktasina Getir"
  #define MAIN_MENU_ITEM_1_GCODE "G92 X0 Y0 Z0 V0 U0"
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Tum Eksenleri 0'a Getir"
  #define MAIN_MENU_ITEM_2_GCODE "G0 X0 Y0 Z0 U0 V0" 
  #define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "X Eksenini 0'a Getir"
  #define MAIN_MENU_ITEM_3_GCODE "G0 X0" 
  #define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Y Eksenini 0'a Getir"
  #define MAIN_MENU_ITEM_4_GCODE "G0 Y0" 
  #define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Z Eksenini 0'a Getir"
  #define MAIN_MENU_ITEM_5_GCODE "G0 Z0" 
  #define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "U Eksenini 0'a Getir"
  #define MAIN_MENU_ITEM_6_GCODE "G0 U0" 
  #define MAIN_MENU_ITEM_6_CONFIRM

  #define MAIN_MENU_ITEM_7_DESC "V Eksenini 0'a Getir"
  #define MAIN_MENU_ITEM_7_GCODE "G0 V0" 
